...
@app.on_message(filters.command(["/addsudo", "رفع مطور", "/رفع مطور"]) & filters.user(OWNER_ID))
@language
...
@app.on_message(filters.command(["قائمة المطورين", "المطورين", "/المطورين"]) & ~BANNED_USERS)
@language
