...
@app.on_callback_query(filters.regex("^moderngame (\\d+)$"))
async def moderngame(c: Client, m: CallbackQuery):
    a = m.data.split("الالعاب")
...
@app.on_callback_query(filters.regex("^sourcegame (\\d+)$"))
...
@app.on_callback_query(filters.regex("^allgame2 (\\d+)$"))
...
@app.on_callback_query(filters.regex("^ttgwzeny$"))
